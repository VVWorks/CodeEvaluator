...
# How to use:
   First copy your inputs in the TESTS/INPUTSfolder and outputs in the TESTS/OUTPUT folder. Then use the command *update* to link the tests with the program. You can view certain tests, deactivate them and so on. To see the commands for doing this type *help*. Next, you should link your executable as well using the command 
